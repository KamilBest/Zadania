...
public class gra_w_kosci {
    private static boolean prawidlowy_rzut(int pierwszy) {
    ...
    private static int gra(String nazwa_gracza) {
        int numer_rzutu = 1;
    ...
    public static void main(String[] args) {
        String gracz1 = "pierwszy";
        String gracz2 = "drugi";
        String aktualny_gracz = gracz1; //zaczyna gracz pierwszy
        ...
        while (numer_tury <= 5) {
            System.out.println("\nTura: " + numer_tury);
            suma_pkt_g1 += gra(gracz1);
            suma_pkt_g2 += gra(gracz2);
            System.out.println("\nPODSUMOWANIE - wyniki: ");
            System.out.println("Gracz "+ gracz1 + " ma : "+suma_pkt_g1+"pkt.");
            System.out.println("Gracz "+ gracz2 + " ma : "+suma_pkt_g2+"pkt.");
            numer_tury++;
        }
